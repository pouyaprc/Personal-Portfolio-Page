...
function EliminationAfterDelay(element, delay) {
  setTimeout(function() {
    ...
    if (window.innerWidth > 1200) {
      ...
      next.addEventListener('click', function(){
        ...
        if(clickCounter == 1) {
          ...
          EliminationAfterDelay(mainIntro, 750);
          EliminationAfterDelay(mainQuotes, 750);
          EliminationAfterDelay(mainSpotlight, 750);
