...
document.addEventListener('DOMContentLoaded', function() {
  setTimeout(function() {
    ...
    if (window.innerWidth < 480) {
      ...
      const mainSpotlightSec = document.querySelector(".main-spotlight-second");
      let mainQuotesText = document.querySelectorAll(".main-quotes p");
      mainIntro.style.transition = 'All 1s ease-in-out';
      mainSpotlight.style.transition = 'All 1s ease-in-out';
      mainSpotlightSec.style.transition = 'All 1s ease-in-out';
      ...
      mainSpotlight.style.transform = 'scaleX(1)';
      mainSpotlightSec.style.transform = 'scaleX(-1)';
